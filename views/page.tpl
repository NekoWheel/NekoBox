...
<div class="uk-card uk-card-default uk-text-center">
    <div class="uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light"
         data-src="{{ .pageContent.Background }}?x-oss-process=image/auto-orient,1/quality,q_70/sharpen,200" uk-img>
        <div class="uk-card-body">
            <img class="uk-border-circle uk-box-shadow-large" src="{{ .userContent.Avatar }}?x-oss-process=image/auto-orient,1/quality,q_70/sharpen,200/resize,limit_0,m_fill,w_200,h_200" width="100" height="100">
